...
abstract public class ModbusDataSourceVO<T extends ModbusDataSourceVO<?>> extends DataSourceVO<T> {
    ...
    protected void addPropertyChangesImpl(List<LocalizableMessage> list, T from) {
        AuditEventType.maybeAddPeriodChangeMessage(list, "dsEdit.updatePeriod", ((ModbusDataSourceVO)from).updatePeriodType,
                ((ModbusDataSourceVO)from).updatePeriods, updatePeriodType, updatePeriods);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.quantize", ((ModbusDataSourceVO)from).quantize, quantize);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.timeout", ((ModbusDataSourceVO)from).timeout, timeout);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.retries", ((ModbusDataSourceVO)from).retries, retries);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.contiguousBatches", ((ModbusDataSourceVO)from).contiguousBatches,
                contiguousBatches);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.createSlaveMonitorPoints",
                ((ModbusDataSourceVO)from).createSlaveMonitorPoints, createSlaveMonitorPoints);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.maxReadBitCount", ((ModbusDataSourceVO)from).maxReadBitCount,
                maxReadBitCount);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.maxReadRegisterCount",
                ((ModbusDataSourceVO)from).maxReadRegisterCount, maxReadRegisterCount);
        AuditEventType.maybeAddPropertyChangeMessage(list, "dsEdit.modbus.maxWriteRegisterCount",
                ((ModbusDataSourceVO)from).maxWriteRegisterCount, maxWriteRegisterCount);
    }
